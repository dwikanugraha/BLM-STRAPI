...
export interface ApiAktivitasSAktivitasS extends Struct.CollectionTypeSchema {
  collectionName: 'aktivitas_p';
  info: {
    description: '';
    displayName: 'Aktivitas';
    pluralName: 'aktivitas-p';
    singularName: 'aktivitas-s';
  };
  options: {
